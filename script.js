    ...
    () => `
      ...
      <div class="about-hero-card">
        <div class="about-avatar-wrap">
          <img src="assets/pic1.jpeg" alt="El Moufaddal Maadi" class="about-avatar-img">
    ...
    () => `
      <div class="empty" style="padding: 40px 20px;">
        ...
        <div style="display: flex; gap: 12px; justify-content: center; flex-wrap: wrap;">
          <a href="assets/ElMoufaddal__Resume.pdf" target="_blank" class="empty a" style="background: #2563eb; color: #fff; font-weight: 600; padding: 12px 22px; border-radius: 8px; text-decoration: none; box-shadow: 0 4px 14px rgba(37,99,235,0.4);">
            📄 ${t("Open Resume in New Tab", "Ouvrir le CV")} ↗
          </a>
          <a href="assets/ElMoufaddal__Resume.pdf" download="El_Moufaddal_Maadi_CV.pdf" class="empty a" style="background: rgba(255,255,255,0.1); border: 1px solid rgba(255,255,255,0.2); color: #fff; font-weight: 600; padding: 12px 22px; border-radius: 8px; text-decoration: none;">
...
function open(name) {
  ...
  let leftPos = isMobile
    ? 8
    : Math.max(20, Math.min(100 + n, Math.max(20, window.innerWidth - 820)));
  let topPos = isMobile
    ? 10
    : Math.max(
        20,
        Math.min(45 + n / 2, Math.max(20, window.innerHeight - 560)),
      );
...
function enableTerminal(w) {
  ...
  const reply = (cmd) =>
    ({
      ...
      whoami:
        "El Moufaddal Maadi — Développeur Full Stack & Automatisation basé à Tanger, Maroc.",
      skills:
        "PHP, JavaScript (ES6+), Python, SQL, Java | React.js, HTML5, CSS3, Bootstrap, WordPress, Elementor | Laravel, Node.js, Express.js, Spring Boot, API REST, MVC | MySQL, MongoDB, Oracle | Git, GitHub, Docker, Postman",
      projects:
        "1. MedPredict AI (FastAPI, React, Scikit-learn, SHAP, MySQL) [ON RESUME]\n2. THE GUIDE (React, Laravel, MySQL) [ON RESUME]\n3. NetPulse (Python, Node, Docker, WebSockets) [IN PROGRESS]\n4. OmniStore (Spring Boot Java, React, Redis) [IN PROGRESS]\n5. DevTask CLI (Python, Bash, Docker) [IN PROGRESS]",
      experience:
        "Web Media Networks, Analyste Développeur — Automatisation & Infrastructure Email (08/2025 - 08/2026 | Tanger)",
      education:
        "1. HIGH-TECH Rabat (Licence Génie Informatique)\n2. OFPPT ISTA NTIC Tanger (Web Full-Stack)\n3. FPL Larache (Sciences Physiques SMP)\n4. Lycée Mansour Dahbi (Baccalauréat)",
      rust: "🚬 \"Time is a flat circle. Everything we've ever done or will do, we're gonna do over and over again...\" — Rust Cohle",
      quote:
        '🚬 "I consider myself a realist, but in engineering terms I design for resilience." — Rust Cohle',
      contact:
        "Email: maadimfdal@gmail.com | Phone: +212 631 361 235 | GitHub: github.com/Mfdalmaadi",
  ...
  form.onsubmit = (e) => {
    ...
    out.insertAdjacentHTML(
      "beforeend",
      `<br><span class="prompt">moufaddal@portfolio:~$</span> ${cmd}<br>${reply(cmd)}`,
    );
    input.value = "";
...
function updateClock() {
  ...
  const dateStr = d.toLocaleDateString(fr ? "fr-FR" : "en-GB", {
    weekday: "long",
    day: "numeric",
    month: "long",
  });
